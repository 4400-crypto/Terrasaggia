...
const PRODUCTS = [
  ...
  // ── LEGNAME ULTRA-RARO ────────────────────────────
  { id:101, name:'Ebano del Gabon — Il Legno più Raro al Mondo', cat:'legname', catLabel:'Legname Pregiato', price:195000, priceLabel:'€ 195.000', unit:'per m³', badge:'RARISSIMO', desc:'Diospyros crassiflora del Gabon equatoriale — il legno più pesante e duro del pianeta, densità 1.080 kg/m³, affonda nell\'acqua. Il colore è nero assoluto senza venature visibili. Proveniente da stock legale pre-CITES certificato FLEGT con catena di custodia documentata dal 1998. Quantità disponibile: 4 m³ totali nel stock.', detail:'Specie: Diospyros crassiflora | Origine: Gabon, stock pre-CITES FLEGT | Densità: 1.080 kg/m³ (affonda) | Durezza Brinell: 130 | Colore: Nero assoluto | Stock disponibile: 4 m³ | Uso: Tasti di pianoforte, bacchette da direttore, gioielleria in legno', available:true },
  { id:102, name:'Sandalo Bianco di Mysore — Essenza Sacra', cat:'legname', catLabel:'Legname Pregiato', price:280000, priceLabel:'€ 280.000', unit:'per m³', badge:'RARISSIMO', desc:'Santalum album di Mysore — l\'unica regione dove il sandalo produce l\'olio essenziale con concentrazione in α-santololo superiore al 90%. Legno proibito all\'esportazione dall\'India nel 1988; il nostro stock proviene da una confisca governativa legalmente acquistata all\'asta nel 2003, con documentazione completa. Profumo persistente per decenni.', detail:'Specie: Santalum album | Origine: Mysore, Karnataka | α-santololo: >90% | Provenienza legale: Asta governativa 2003, doc. allegata | Stock residuo: 2,5 m³ | Uso: Scultura sacra, incenso, profumeria di lusso, medicina ayurvedica | Profumo: Persistente oltre 50 anni', available:true },
  { id:103, name:'Ziricote del Belize — Tavole da Liuteria', cat:'legname', catLabel:'Legname Pregiato', price:68000, priceLabel:'€ 68.000', unit:'per m³', badge:'RARO', desc:'Cordia dodecandra del Belize con venatura "ragnatela" — effetto ottico naturale causato dall\'intreccio di fibre che crea disegni simili a ragnatele o paesaggi aerei. Usato dai più grandi liutai per fondali di chitarre acustiche firmate (Taylor, Santa Cruz, Collings). La nostra fornitura è l\'unica disponibile in Europa.', detail:'Specie: Cordia dodecandra | Origine: Belize, foresta pluviale certificata | Venatura: "Ragnatela" naturale (rara) | Uso liuteria: Fondali chitarre acustiche top tier | Disponibilità: Unica in Europa | Stagionatura: 6 anni | Certificazione: FSC importazione', available:true },
  { id:104, name:'Lignum Vitae — Il Legno che Galleggia a Malapena', cat:'legname', catLabel:'Legname Pregiato', price:89000, priceLabel:'€ 89.000', unit:'per m³', badge:'RARISSIMO', desc:'Guaiacum officinale — il legno più duro al mondo per durezza Janka (4.500 lbf) con resina naturale auto-lubrificante integrata nella fibra. Usato storicamente per cuscinetti di alberi di propulsione navale. Le nostre tavole provengono da piantagioni certificate in Guatemala, uniche autorizzate all\'esportazione in EU.', detail:'Specie: Guaiacum officinale | Durezza Janka: 4.500 lbf (record mondiale) | Resina: Auto-lubrificante naturale 27% | Uso storico: Cuscinetti navi, bocce da bowling professionale | Certificazione: CITES Appendice II export Guatemala | Densità: 1.230 kg/m³', available:true },

  // ── VINI & DISTILLATI ULTRA-RARI ──────────────────
  { id:105, name:'Sassicaia Numerata 2016 — Jeroboam 3L', cat:'vini', catLabel:'Vini & Distillati', price:38000, priceLabel:'€ 38.000', unit:'per Jeroboam (3L)', badge:'LUXURY', desc:'Sassicaia 2016 in formato Jeroboam da 3L — considerata la migliore annata della storia della Tenuta San Guido. Punteggio unanime: 100/100 Parker, 100/100 Gambero Rosso, 98/100 Wine Spectator. Solo 180 Jeroboam prodotti per l\'intera annata mondiale. Cassa legno numerata con certificato di autenticità e fascetta originale.', detail:'Denominazione: Bolgheri Sassicaia DOC | Annata: 2016 | Formato: Jeroboam 3L | Parker: 100/100 | Produzione formato: 180 pezzi mondiale | Affinamento: 24 mesi barrique nuove + 12 mesi bottiglia | Cassa: Legno numerata con certificato', available:true },
  { id:106, name:'Petrus 2015 — Pomerol in Magnum', cat:'vini', catLabel:'Vini & Distillati', price:58000, priceLabel:'€ 58.000', unit:'per magnum (1,5L)', badge:'RARISSIMO', desc:'Petrus 2015 in formato Magnum — il vino più famoso del mondo da Merlot puro su argilla blu Pomerol. Produzione annua totale inferiore a 30.000 bottiglie; il Magnum vale tre volte la bottiglia per la maturazione più lenta e profonda. Provenienza: allocazione diretta, catena di custodia certificata dal domaine.', detail:'Produttore: Château Petrus, Pomerol AOC | Annata: 2015 | Vitigno: Merlot 100%, argilla blu | Formato: Magnum 1,5L | Alcol: 14,5% | Provenienza: Allocazione diretta domaine | Conservazione: Cellar 13°C da arrivo', available:true },
  { id:107, name:'Whisky Macallan 30 Anni Sherry Oak', cat:'vini', catLabel:'Vini & Distillati', price:12500, priceLabel:'€ 12.500', unit:'per bottiglia (0,7L)', badge:'RARISSIMO', desc:'The Macallan 30 anni affinato esclusivamente in botti di Sherry Oloroso spagnolo. Colore mogano profondo con sfumature ambrate. Note di cioccolato fondente 85%, arancio amaro, noce, cannella e fiori secchi. Ogni bottiglia è numerata e corredata di astuccio in pelle con sigillo in cera. Ritenuto da Whisky Bible il miglior singolo malto del 2023.', detail:'Distilleria: The Macallan, Speyside | Età: 30 anni | Botti: Sherry Oloroso spagnolo 100% | Alcol: 43% | Colore: Mogano profondo | Whisky Bible 2023: Miglior singolo malto | Astuccio: Pelle, sigillo in cera, numerato', available:true },
  { id:108, name:'Rum Agricolo Martinicana 1985 — Fondo di Botte', cat:'vini', catLabel:'Vini & Distillati', price:18000, priceLabel:'€ 18.000', unit:'per bottiglia (0,7L)', badge:'RARISSIMO', desc:'Rum agricolo AOC Martinique distillato nel 1985 da puro succo di canna fresca, invecchiato 38 anni in botti di rovere francese. L\'evaporazione — "la parte degli angeli" — ha ridotto il contenuto originale del 60%. Note di tabacco cubano, vaniglia Bourbon, fico secco, spezie orientali e caramello salato. Solo 12 bottiglie disponibili.', detail:'Denominazione: AOC Martinique Rhum Agricole | Distillazione: 1985, succo canna fresca | Invecchiamento: 38 anni rovere francese | Evaporazione: 60% volume originale | Alcol: 46,2% naturale | Disponibilità: 12 bottiglie | Note: Tabacco, vaniglia Bourbon, fico secco', available:true },

  // ── CARNI ULTRA-PREGIATE ──────────────────────────
  { id:109, name:'Kobe Beef Certificato A5 BMS12 — Filetto Hyogo', cat:'carni', catLabel:'Carni Pregiate', price:24000, priceLabel:'€ 24.000', unit:'per kg', badge:'RARISSIMO', desc:'Wagyu di Kobe (Tajima-gyu) certificato dalla Kobe Beef Marketing & Distribution Promotion Association con numero di serie individuale tracciabile all\'animale. Allevato nella Prefettura di Hyogo con acqua di sorgente locale e massaggi quotidiani. BMS 12 — il massimo della classificazione giapponese. Unico importatore autorizzato in Italia.', detail:'Razza: Tajima-gyu (Kobe Beef) | Certificazione: KBMDPA con n° serie | Prefettura: Hyogo | BMS: 12 (massimo) | Massaggi: Quotidiani, sake bath | Importatore: Unico autorizzato Italia | Spedizione: Refrigerata 0–2°C, 24h da Osaka', available:true },
  { id:110, name:'Jamón Ibérico Pata Negra 100% — Gran Riserva 5 Anni', cat:'carni', catLabel:'Carni Pregiate', price:9800, priceLabel:'€ 9.800', unit:'per coscia (~8kg)', badge:'LUXURY', desc:'Pata Negra 100% ibérico de bellota — il massimo della piramide qualitativa spagnola — da suino nero iberico puro allevato nella Dehesa di Jabugo. Ghiandatura autunnale (montanera) per 4 mesi prima della macellazione. Stagionatura 60 mesi nel secadero di Jabugo. Grasso infiltrato quasi insaturo come l\'olio d\'oliva. Paleta Negra 5J originale.', detail:'Razza: 100% Ibérico negro puro | Alimentazione: Bellota (ghiande) in montanera | Dehesa: Jabugo, Huelva | Stagionatura: 60 mesi in secadero naturale | Grasso: Oleico >68%, quasi insaturo | Peso coscia: 7,5–9 kg | Marchio: 5J Sánchez Romero Carvajal', available:true },
  { id:111, name:'Foie Gras d\'Oca Grand Cru — Fegato Intero Fresco', cat:'carni', catLabel:'Carni Pregiate', price:5800, priceLabel:'€ 5.800', unit:'per kg', badge:'LUXURY', desc:'Foie gras d\'oca (non d\'anatra) prodotto da oche grigie di Tolosa allevate per 20 settimane nella tenuta partner in Guascogna e gavage manuale per gli ultimi 21 giorni con mais bianco non transgenico. Fegato fresco (non pastorizzato) spedito in gel refrigerante entro 12 ore dalla macellazione. Peso minimo garantito 600g per fegato.', detail:'Animale: Oca grigia di Tolosa (non anatra) | Gavage: 21 giorni, mais bianco non OGM, manuale | Provenienza: Guascogna, tenuta partner | Fegato: Fresco non pastorizzato | Spedizione: 12h dalla macellazione, gel refrigerante | Peso minimo: 600g/fegato | Stagione: Ottobre–Marzo', available:true },
  { id:112, name:'Aragosta Blu Bretone — Viva in Acqua Marina', cat:'carni', catLabel:'Carni Pregiate', price:4200, priceLabel:'€ 4.200', unit:'per kg', badge:'RARO', desc:'Homarus gammarus della Bretagna atlantica — considerata la più pregiata al mondo per la carne soda, dolce e iodica superiore all\'aragosta americana (Homarus americanus). Consegnata viva in acqua marina refrigerata 8°C con ossigenazione attiva. Peso individuale garantito minimo 1,2 kg. Pesca certificata MSC, quota individuale di pescatore artigianale.', detail:'Specie: Homarus gammarus | Provenienza: Bretagna, Atlantico | vs. Americana: Carne più soda, dolce, iodica | Consegna: Viva in acqua marina 8°C con ossigenazione | Peso minimo: 1,2 kg/individuo | Pesca: MSC, quota artigianale | Consegna: Solo martedì e venerdì', available:true },

  // ── PRODOTTI DELLA TERRA ULTRA ────────────────────
  { id:113, name:'Caviale Beluga Albino Huso Huso — Almas', cat:'terra', catLabel:'Prodotti della Terra', price:92000, priceLabel:'€ 92.000', unit:'per 100g', badge:'RARISSIMO', desc:'Caviale Almas: storione albino Huso huso di 100+ anni allevato in Iran. Le uova bianche perlescenti del maschio albino rarissimo — meno di 10 esemplari noti a livello mondiale — hanno un gusto quasi dolce, burroso, con retrogusto di nocciola. Consegnato nella tradizionale lattina Almas in oro 24 carati. L\'unico caviale al mondo che supera regolarmente €10.000/100g.', detail:'Specie: Huso huso albino | Età storione: >100 anni | Colore uova: Bianco perlescente | Produzione mondiale: <500g/anno | Lattina: Oro 24 carati originale | Provenienza: Iran certificata CITES | Note: Burro, nocciola, lieve dolcezza | Conservazione: -2°C, consumare entro 30 gg', available:true },
  { id:114, name:'Tartufo Bianco — Esemplare Singolo da Record (800g)', cat:'terra', catLabel:'Prodotti della Terra', price:285000, priceLabel:'€ 285.000', unit:'per esemplare', badge:'RARISSIMO', desc:'Un singolo esemplare di Tuber magnatum Pico da 800g — dimensione record che si presenta in natura meno di 5 volte per decennio. La dimensione straordinaria è possibile solo grazie al microclima unico della tartufaia segreta della tenuta, con tre sorgenti sotterranee che mantengono la temperatura del terreno a 8°C costanti tutto l\'anno. Consegna in elicottero entro 6 ore.', detail:'Varietà: Tuber magnatum Pico | Peso: ~800g singolo esemplare | Frequenza: <5 volte/decennio in natura | Provenienza: Tartufaia segreta Terrassaggia | Consegna: Entro 6h, elicottero su richiesta | Certificato di autenticità: Numerato, con coordinate GPS raccolta | Confanetto: Noce massello, intarsiato', available:true },
  { id:115, name:'Pepe Kampot Rosso Fermentato — Riserva Privata', cat:'terra', catLabel:'Prodotti della Terra', price:3800, priceLabel:'€ 3.800', unit:'per 100g', badge:'RARISSIMO', desc:'Pepe Kampot (IGP Cambogia) varietà rossa fermentata — si ottiene lasciando maturare le bacche verdi sulla pianta fino al rosso completo, poi fermentandole 6 settimane in soluzione salina naturale. Produzione inferiore al 2% del totale Kampot. Note di frutta rossa, cioccolato, tabacco e spezie. Il pepe più premiato degli ultimi 5 anni alle Worlds Spice Championships.', detail:'Varietà: Kampot IGP rosso fermentato | Fermentazione: 6 settimane in soluzione salina | Produzione: <2% del totale Kampot | Campionati: Worlds Spice Championships 2020–2024 | Note: Frutta rossa, cioccolato, tabacco | Piperina: 6× pepe nero | Consegna: Sottovuoto azoto', available:true },
  { id:116, name:'Aceto Balsamico Tradizionale — 60 Anni Centenario', cat:'terra', catLabel:'Prodotti della Terra', price:32000, priceLabel:'€ 32.000', unit:'per 100ml', badge:'RARISSIMO', desc:'La batteria di botti risale al 1964. Sessant\'anni di lenta concentrazione in sette legni diversi hanno prodotto un aceto denso come melassa — densità 1,58 g/mL, la più alta mai registrata dal Consorzio. Solo 8 bottiglie di questo lotto verranno messe in commercio. Ogni bottiglia porta il timbro del Consorzio ABTM e il numero di serie inciso a mano sul vetro.', detail:'Invecchiamento: 60 anni | Batteria: Dal 1964, 7 legni | Densità: 1,58 g/mL (record ABTM) | Produzione annua: 8 bottiglie | Bottiglia: Design Giugiaro, numero inciso a mano | Certificazione: ABTM oro con timbro consorzio | Note: Melassa, prugna cotta, fico, caramello scuro', available:true },

  // ── LATTE & DERIVATI ULTRA ────────────────────────
  { id:117, name:'Parmigiano Reggiano Vacca Rossa — 84 Mesi', cat:'latte', catLabel:'Latte & Derivati', price:6800, priceLabel:'€ 6.800', unit:'per kg', badge:'RARISSIMO', desc:'Il Parmigiano più vecchio disponibile al mondo in commercio: stagionatura 84 mesi (7 anni) da latte di Vacca Rossa Reggiana — razza storica con meno di 3.000 capi in Italia. La pasta è quasi nera, le cristallizzazioni di tirosina formano veri e propri quarzi visibili, il sapore è così intenso che ne bastano 3 grammi per profumare un intero piatto. Produzione: 4 forme all\'anno.', detail:'Latte: Vacca Rossa Reggiana (<3.000 capi) | Stagionatura: 84 mesi (7 anni) | Pasta: Quasi nera, cristalli visibili | Cristalli tirosina: 6–8mm (quarzi) | Produzione: 4 forme/anno | Forma intera: 38 kg | Sapore: Bastano 3g per un piatto | Note: Ammoniaca, noce, spezie orientali, umami puro', available:true },
  { id:118, name:'Formaggio di Fossa di Sogliano — Riserva Privata', cat:'latte', catLabel:'Latte & Derivati', price:4200, priceLabel:'€ 4.200', unit:'per kg', badge:'RARO', desc:'Formaggio di Fossa DOP sepolto nelle fosse tufaree di Sogliano al Rubicone ogni agosto e riesumato a San Martino (11 novembre) dopo 90 giorni di fermentazione anaerobica. Il formaggio sviluppa nella fossa una muffa nobile autoctona unica che crea un sapore aspro, intenso, quasi animale — incomprensibile finché non lo si assaggia. La nostra riserva esclude la produzione di massa: solo forme da 500g di latte ovino puro.', detail:'Denominazione: Formaggio di Fossa DOP | Produzione: Sogliano al Rubicone | Fermentazione: 90 giorni in fossa tufarea anaerobica | Latte: Ovino puro (esclusivo rispetto a vacca) | Forma: 500g | Muffa: Autoctona fossa, non inoculata | Note: Aspro, intenso, quasi animale, retrogusto lungo | Stagione: Riesumazione 11 novembre', available:true },
  { id:119, name:'Vacherin Mont d\'Or — Stagione d\'Inverno Esclusiva', cat:'latte', catLabel:'Latte & Derivati', price:2800, priceLabel:'€ 2.800', unit:'per kg', badge:'STAGIONALE', desc:'Vacherin Mont d\'Or AOC svizzero — il formaggio più stagionale al mondo, prodotto solo da agosto a marzo con latte di mucche che scendono dall\'alpeggio. La crosta lavata e la fascia di abete rosso fanno penetrare nella pasta un profumo resinoso unico. Il nostro importatore è l\'unico autorizzato direttamente dalla Coopérative du Mont-d\'Or per il mercato italiano.', detail:'Denominazione: Vacherin Mont d\'Or AOC | Produzione: Agosto–Marzo (strettamente stagionale) | Fascia: Abete rosso del Jura | Crosta: Lavata, arancio-rosata | Pasta: Cremosa, quasi liquida a maturità | Importatore: Unico autorizzato per Italia | Note: Resinoso, crema, funghi, lieve acidità | Consumo: Riscaldato in forno 180°C 15 min', available:true },
  { id:120, name:'Époisses de Bourgogne — Affinato al Marc de Bourgogne', cat:'latte', catLabel:'Latte & Derivati', price:2200, priceLabel:'€ 2.200', unit:'per kg', badge:'RARO', desc:'Époisses AOC — il formaggio proibito sui mezzi pubblici francesi per la potenza dell\'odore — prodotto nella Côte-d\'Or e affinato 6 settimane con lavaggi quotidiani di Marc de Bourgogne (grappa di Borgogna). Crosta arancione brillante quasi liquida, pasta bianca cremosa irresistibile. Napoleone Bonaparte ne era ossessionato. Importazione diretta dalla famiglia Gaugry, gli inventori moderni.', detail:'Denominazione: Époisses de Bourgogne AOC | Affinatura: 6 settimane, lavaggi quotidiani Marc de Bourgogne | Produttore: Famille Gaugry (inventori ricetta moderna) | Crosta: Arancione brillante, quasi liquida | Pasta: Bianca, cremosa, note forti | Curiosità: Vietato sui treni francesi | Note: Erborinato, piccante, persistente | Importazione: Diretta', available:true },
